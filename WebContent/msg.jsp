...
<html lang="zh-CN">
    ...
    <div class="main-white">
        <div class="container travel-main">
            ...
            <p class="text-center success-text" style="color: red;font-size: 30px;">${msg }</p>
            <p class="text-center success-detail"> 将在 <span id="mes">3</span> 秒钟后返回！</p>
            <a href="index.jsp"  class="main-bg text-center text-color5 see-order">立即返回</a>
        </div>
    </div>
