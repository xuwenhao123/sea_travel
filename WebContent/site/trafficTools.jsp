...
<div class="main-white">
	<div class="container">
        <div id="swiper2" class="swiper-container" style="overflow:visible;">
            <h2 class="text-center common-h2 font-size4">${att_name }可预订租用交通工具信息</h2>
            <div class="swiper-wrapper computer-swiper">
            </div>
        </div>
	</div>
</div>
    <form id="intent-form"  name="f1" action="${pageContext.request.contextPath}/servicer?method=toServicer" method="post">
    <div class="container">
        <div class="row"></div>
        <div class="row btn-group" role="group">
               <c:forEach items="${tlsit }" var="t">
	              <div class=" col-md-4">
                        <a href="#" >
                        <div class="comment-section">
                            <img src="../idimage/Car1.jpg"  alt="" class="img-responsive" style="width:750px;">
                            
                        </div>
                        <p>
                            <span class="text-overflow font-size2 common-name">&nbsp;&nbsp;&nbsp;&nbsp;${t.type }</span>
                            <span class="text-right text-overflow main-color"><strong class="font-size2">&nbsp;&nbsp;&nbsp;&nbsp;CNY ${t.min_price }</strong>/日</span>
                        </p>
                         <p>
                            <span class="text-overflow">&nbsp;&nbsp;&nbsp;&nbsp;${t.brand }</span>
                            <span class="text-overflow">&nbsp;&nbsp;&nbsp;&nbsp;限载${t.people_num }人</span>
                            
                        </p>
                        <p class="font-size1 text-color2 text-overflow">
                          <span class="guide-tag">&nbsp;&nbsp;&nbsp;&nbsp;${h.detail }</span>
                        </p></a>                          
                        <input type="radio" value="${t.t_id }" name="ra" style="margin-left: 20px;"> <span class="text-right text-overflow main-color"><strong class="font-size2">选中该交通工具</strong></span>
        ...
        <div class="row" style="height:100px;"></div>
         ...
         <button class="main-bg submit-btn text-center text-color5" type="button" style="margin-left:200px;float: left; " onclick="javascript:window.location.href='#'">忽略，下一步</button>
