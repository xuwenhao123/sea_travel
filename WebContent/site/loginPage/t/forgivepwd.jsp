...
<html lang="zh-CN">
    <head>
		...
		<script src="../../../js/promptbox/prompt_box.js" ></script>
				...
				ga('create', 'UA-56466931-1', 'auto');
				ga('send', 'pageview');*/
				//百度统计
				var _hmt = _hmt || [];
				(function() {
					var hm = document.createElement("script");
					hm.src = "../../../js/hm.js-80321a423f19a4e03ba6d42247ed8506"/*tpa=http://hm.baidu.com/hm.js?80321a423f19a4e03ba6d42247ed8506*/;
				...
				window._vds = _vds;
				(function() {
			_vds.push(['setAccountId', 'bd5c07316e4f7d9c']);
								(function() {
				...
				<div class="container">
					...
					<div class="navbar-collapse collapse" role="navigation">
						<ul class="nav navbar-nav nav-ul">
							...
							<li class="slide-li mian-top"><a href="../../html/id/why_guide.htm" >成为丸子</a></li>
							<li class=" mian-top"><a href="../../group.htm"  target="_blank">团队企业服务</a></li>
															<li class="load-img">
									<a href="javascript:;">下载APP</a>
									<div class="load-section"><img src="../../../images/APP-img.png"  alt="">
										<div>
											<p><span class="text-center">下载丸子地球</span><span class="text-center">下载丸子地球</span></p>
											<p><span class="text-center">旅行者端APP</span><span class="text-center">向导端APP</span></p>
										</div>
									</div>
								</li>
													</ul>
						<ul class="nav navbar-nav navbar-right hidden-sm nav-ul login-ul">
							...
							<li><a href="register.jsp"  class="login-section">注册</a></li>
							<li><a href="login.jsp"  class="login-line">登录</a></li>
						</ul>
					</div>
				</div>
			</div>
        ...
        <div class="col-md-8" style="background:#fff; margin:20px 0 20px;">
            <form style="margin:20px;">
                ...
                <div class="row">
                    ...
                    <div class="col-md-5">
                        <p><input type="text" class="form-control" placeholder="手机号（不含国家区号）" id="user_phone"></p>
                    </div>
                    <div class="col-md-2"></div>
                </div>
                <div class="row">
                    <div class="col-md-2"></div>
                    <div class="col-md-3">
                        <p><input type="text" class="form-control" id="validate_code"></p>
                    </div>
                    <div class="col-md-2">
                        <p>
                            <a href="javascript:;" id="get_new_code"><img src="../../../public/imageCode.png"  style="width:100%;height:32px;" /></a>
                        </p>
                    </div>
                    <div class="col-md-3">
                        <button type="button" class="btn btn-default btn-block btn-info" id="send_code">发送短信验证码</button>
                    </div>
                    <div class="col-md-2"></div>
                </div>
                <p>&nbsp;</p>
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <p>
                            <input type="text" class="form-control" placeholder="短信验证码（4位数字）" id="reg_code">
                        </p>
                        <p>
                        ...
                        <p>&nbsp;</p>
                        <p>
                            <input type="hidden" value="acf61914cb0bc742d9b83cba7a79b7ef" name="csrf_token" />                            <button type="button" class="btn btn-info btn-lg btn-block" id="reset_password">确定</button>
                        </p>
                    </div>
                    <div class="col-md-2"></div>
                </div>
...
$(document).ready(function(){
    $('#get_new_code').on('click', changeCode);
    function changeCode() {
        $('#get_new_code img').attr('src', '/public/imageCode/r/'+(new Date()/1000));
    }
    $('#send_code').on('click', function(){
        ...
        $.post(
            '/public/sendCode',
            {phone: $('#phone_prefix').val() + user_phone, check: 0, validate_code: validate_code},
            function(data){
                if (data.code != 1000) {
                    alert(data.error);
                } else {
