...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-8" style="background:#fff; margin:20px 0 20px;">
            <form style="margin:20px;" method="post" action="${pageContext.request.contextPath}/user?method=register">
                <legend>用户注册</legend>
                <div class="row">
                    <div class="col-md-2"></div>
                    <div class="col-md-8">
                        <p>
                            <input type="text" class="form-control" placeholder="手机号（不含国家区号）" id="username" name="username">
                        </p>
                        <p>
                        ...
                        <p>
                           <input type="date" class="form-control" id="birthday" name="birthday" placeholder="日历">
                        </p>
                        <p>
                           <input type="text" class="form-control" id="hobby" name="hobby" placeholder="个人兴趣">
                        </p>
                        <p>
                        ...
                        <p>&nbsp;</p>
                        <p>
                            <input type="submit" class="btn btn-info btn-lg btn-block" value="注册" id="register">
                        </p>
                        <p class="text-color2 rester-explain">注册账号即代表您同意本网站的<a href="../../html/id/terms_service.htm"  class="main-color">《服务条款》</a>、
                            <a href="../../html/id/privacy_policy.htm"  class="main-color">《隐私政策》</a>、
                            <a href="../../html/id/disclaimer.htm"  class="main-color">《免责声明》</a>、
                            <a href="../../html/id/terms.htm"  class="main-color">《保障计划条款》</a>。
                        </p>
                    </div>
                    <div class="col-md-2"></div>
                </div>
...
$(document).ready(function(){
    ...
    $('#send_code').on('click', function(){
        ...
        $.post(
            '/public/sendCode',
            {phone: $('#phone_prefix').val() + user_phone, check: 1, validate_code: validate_code},
            function(data){
                if (data.code != 1000) {
                    alert(data.error);
                } else {
